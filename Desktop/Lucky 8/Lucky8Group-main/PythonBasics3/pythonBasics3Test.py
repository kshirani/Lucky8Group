...
#Test case for ends_with_consonant
    def test_ends_with_consonant(self):
        ...
        self.assertEqual(pythonBasics3.ends_with_consonant("Ahoy matey!"), False)

        self.assertEqual(pythonBasics3.ends_with_consonant("Top of the mornin' to ya"), False)

        self.assertEqual(pythonBasics3.ends_with_consonant("Hello Litzy"), True)
